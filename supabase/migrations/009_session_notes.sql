-- ============================================================
-- Migration 009: Operational note per session
-- An optional, multi line note shown directly under each session
-- on the display board. For OT cover, special instructions, staff
-- reminders, venue notes and last minute updates.
-- Run after 008_questions.sql.
-- ============================================================

alter table event_sessions
  add column if not exists note text not null default '';

-- ---------- Return the session note from the public display function ----------
