...
- Apply `supabase/migrations/20260913081307_session_floor_plans_and_grid.sql` before deploying this version. It adds a nullable session attachment reference and an authenticated, RLS-respecting worksheet update function. It retains the public board's existing visibility rules and storage permissions.
