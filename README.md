...
- **By date** shows every session in global date/time order, with its event heading directly above it. There is no extra date toolbar or collapsed date group. Dates remain visible inside session cards, and unassigned tasks stay on their event date.
